...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_MOMSAVEDMONEY]                        = COMPOUND_STRING("MOM put ¥{B_BUFF2} away for you!\p"),
    ...
    [STRINGID_PKMNSPUNCOCOON]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} spun itself into a cocoon!"),
