...
const u16 *const gTeachableLearnsets_Kismet[NUM_SPECIES + 1] = {
    ...
    [SPECIES_FLETCHLING] = sFletchinderTeachableLearnset_Kismet,
...
#endif
#if P_FAMILY_KLINK
    [SPECIES_KLANG] = sKlangTeachableLearnset_Kismet,
    [SPECIES_KLINK] = sKlangTeachableLearnset_Kismet,
    ...
    [SPECIES_LAMPENT] = sLampentTeachableLearnset_Kismet,
    [SPECIES_LITWICK] = sLampentTeachableLearnset_Kismet,
#endif
#if P_FAMILY_LOTAD
    ...
    [SPECIES_MACHOKE] = sMachokeTeachableLearnset_Kismet,
    [SPECIES_MACHOP] = sMachokeTeachableLearnset_Kismet,
#endif
    ...
    [SPECIES_SPHEAL] = sSealeoTeachableLearnset_Kismet,
...
#endif
#if P_FAMILY_TURTWIG
    [SPECIES_GROTLE] = sGrotleTeachableLearnset_Kismet,
    [SPECIES_TORTERRA] = sTorterraTeachableLearnset_Kismet,
    [SPECIES_TURTWIG] = sGrotleTeachableLearnset_Kismet,
#endif
#if P_FAMILY_TYNAMO
    ...
    [SPECIES_VANILLISH] = sVanillishTeachableLearnset_Kismet,
    [SPECIES_VANILLITE] = sVanillishTeachableLearnset_Kismet,
    ...
    [SPECIES_GEOWATT] = sGeowattTeachableLearnset_Kismet,
    ...
    [SPECIES_PSYCHU] = sPsychuTeachableLearnset_Kismet,
