...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_CHAMPION_HNS] =         { _("CHAMPION"), 50, BALL_PREMIER },
    [TRAINER_CLASS_COLLECTOR_HNS] =        { _("COLLECTOR"), 15, BALL_PREMIER },
    [TRAINER_CLASS_ACE_TRAINER_HNS] =      { _("ACE TRAINER"), 12, BALL_GREAT },
    [TRAINER_CLASS_DOME_ACE_HNS] =         { _("DOME ACE") },
    [TRAINER_CLASS_DRAGON_TAMER_HNS] =     { _("DRAGON TAMER"), 12, BALL_GREAT },
    [TRAINER_CLASS_ELITE_FOUR_HNS] =       { _("ELITE FOUR"), 25, BALL_ULTRA },
    [TRAINER_CLASS_EXPERT_HNS] =           { _("EXPERT"), 10, BALL_ULTRA },
    ...
    [TRAINER_CLASS_SUPER_NERD_HNS] =       { _("SUPER NERD"), 8, BALL_GREAT },
    ...
    [TRAINER_CLASS_DEVELOPER_HNS] =        { _("DEVELOPER"), 50, BALL_LUXURY},
    [TRAINER_CLASS_PYRAMID_KING_HNS] =     { _("PYRAMID KING") },
    [TRAINER_CLASS_GAMBLER_HNS] =          { _("GAMBLER"), 18 },
    [TRAINER_CLASS_NURSE_HNS] =            { _("NURSE"), 12 },
    [TRAINER_CLASS_ELDER_HNS] =            { _("ELDER"), 12 },
    [TRAINER_CLASS_EX_ELITE_HNS] =         { _("EX ELITE"), 25, BALL_ULTRA },
    [TRAINER_CLASS_SCIENTIST_HNS] =        { _("SCIENTIST"), 12 },
    [TRAINER_CLASS_PAINTER_HNS] =          { _("PAINTER"), 4 },
    [TRAINER_CLASS_MASTER_HNS] =           { _("MASTER"), 50 },
    [TRAINER_CLASS_CHANNELER_HNS] =        { _("CHANNELER"), 8 },
    [TRAINER_CLASS_PKMN_RANGER_HNS] =      { _("{PKMN} RANGER"), 12 },
    [TRAINER_CLASS_BUG_MANIAC_HNS] =       { _("BUG MANIAC"), 15 },
    [TRAINER_CLASS_PKMN_BREEDER_HNS] =     { _("{PKMN} BREEDER"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_AROMA_LADY_HNS] =       { _("AROMA LADY"), 10 },
    [TRAINER_CLASS_LADY_HNS] =             { _("LADY"), 50, BALL_LUXURY },
    [TRAINER_CLASS_RUIN_MANIAC_HNS] =      { _("RUIN MANIAC"), 15 },
    [TRAINER_CLASS_RICH_BOY_HNS] =         { _("RICH BOY"), 50, BALL_LUXURY },
};
...
u32 GetBattlerTotalSpeedStat(enum BattlerId battler, enum Ability ability, enum HoldEffect holdEffect)
{
    ...
    if (HasWeatherEffect())
    {
        if (ability == ABILITY_SWIFT_SWIM       && holdEffect != HOLD_EFFECT_UTILITY_UMBRELLA && gBattleWeather & B_WEATHER_RAIN)
            ...
            speed *= 2;
        else if ((ability == ABILITY_SLUSH_RUSH || ability == ABILITY_GLACIAL_DRIFT) && (gBattleWeather & B_WEATHER_ICY_ANY))
            speed *= 2;
    }
