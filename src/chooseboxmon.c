...
static const u16 sPLATutorLearnsets[][2] =
{
    ...
    {SPECIES_EMPOLEON,          MOVE_BLEAKWIND_STORM},
    {SPECIES_DELIBIRD,          MOVE_BLEAKWIND_STORM},

    {SPECIES_ZAPDOS,            MOVE_WILDBOLT_STORM},
    {SPECIES_KILOWATTREL,       MOVE_WILDBOLT_STORM},

    {SPECIES_MOLTRES,           MOVE_SANDSEAR_STORM},
    {SPECIES_FLYGON,            MOVE_SANDSEAR_STORM},
    {SPECIES_GLISCOR,           MOVE_SANDSEAR_STORM},
    ...
    {SPECIES_ALTARIA,           MOVE_ESPER_WING},
    ...
    {SPECIES_ABRA,              MOVE_POWER_TRICK},
    {SPECIES_KADABRA,           MOVE_POWER_TRICK},
    {SPECIES_ALAKAZAM,          MOVE_POWER_TRICK},
    {SPECIES_MACHOP,            MOVE_POWER_TRICK},
    {SPECIES_MACHOKE,           MOVE_POWER_TRICK},
    {SPECIES_MACHAMP,           MOVE_POWER_TRICK},
    {SPECIES_PINECO,            MOVE_POWER_TRICK},
    {SPECIES_FORRETRESS,        MOVE_POWER_TRICK},
    {SPECIES_MEDITITE,          MOVE_POWER_TRICK},
    {SPECIES_MEDICHAM,          MOVE_POWER_TRICK},
    {SPECIES_GLIGAR,            MOVE_POWER_TRICK},
    {SPECIES_GLISCOR,           MOVE_POWER_TRICK},
    {SPECIES_SHUCKLE,           MOVE_POWER_TRICK},
    {SPECIES_BALTOY,            MOVE_POWER_TRICK},
    {SPECIES_CLAYDOL,           MOVE_POWER_TRICK},
};
