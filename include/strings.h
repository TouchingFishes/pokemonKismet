...
extern const u8 BattleFrontier_Lounge7_Text_SoftboiledDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_SeismicTossDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_HypnosisDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_MegaPunchDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_MegaKickDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_BodySlamDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_RockSlideDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_CounterDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_ThunderWaveDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_SwordsDanceDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_DefenseCurlDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_SnoreDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_HeadlongRushDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_BellyDrumDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_IcyWindDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_EndureDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_PsychUpDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_ElectroBallDesc_hns[];
extern const u8 BattleFrontier_Lounge7_Text_FlareBlitzDesc_hns[];
