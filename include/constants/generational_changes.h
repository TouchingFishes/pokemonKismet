...
#define BATTLE_CONFIG_DEFINITIONS(F) \
    ...
    /* Move data settings */ \
    F(B_UPDATED_MOVE_DATA,         updatedMoveData,         (u32, CUSTOM_FOR_KISMET)) /* TODO: use in tests */ \
    F(B_UPDATED_MOVE_TYPES,        updatedMoveTypes,        (u32, CUSTOM_FOR_KISMET)) /* TODO: use in tests */ \
    ...
    F(B_ATE_MULTIPLIER,            ateMultiplier,           (u32, CUSTOM_FOR_KISMET)) \
