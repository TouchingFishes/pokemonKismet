...
enum JohtoDexOrder
{
    ...
    JOHTO_DEX_MEW,
    JOHTO_DEX_CELEBI,
    // --- Kanto stage. Unlocks on reaching Kanto
    JOHTO_DEX_RALTS,
    JOHTO_DEX_KIRLIA,
    JOHTO_DEX_GARDEVOIR,
    JOHTO_DEX_GALLADE,
...
#define JOHTO_DEX_COUNT (JOHTO_DEX_ARCEUS + 1)
...
#define JOHTO_DEX_STAGE_ALOLA_END   JOHTO_DEX_TAPU_FINI
...
enum ObtainableDexOrder {
    ...
    OBTAINABLE_DEX_KLINK,
    OBTAINABLE_DEX_KLANG,
    OBTAINABLE_DEX_KLINKLANG,
    OBTAINABLE_DEX_FLABEBE,
    OBTAINABLE_DEX_FLOETTE,
    OBTAINABLE_DEX_FLORGES,
    OBTAINABLE_DEX_BINACLE,
    OBTAINABLE_DEX_BARBARACLE,
    OBTAINABLE_DEX_GOOMY,
    OBTAINABLE_DEX_SLIGGOO,
    OBTAINABLE_DEX_GOODRA,
    OBTAINABLE_DEX_SALANDIT,
    OBTAINABLE_DEX_SALAZZLE,
    OBTAINABLE_DEX_BRUXISH,
