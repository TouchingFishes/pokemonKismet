...
#define FLAG_HIDE_MIRAGE_ZOROARK                    (HNS_EXTENDED_CONTENT_START + 113) // hide the MIRAGE FOREST ZOROARK once caught or defeated
#define FLAG_BATTLED_MIRAGE_ZOROARK                 (HNS_EXTENDED_CONTENT_START + 114) // battled the MIRAGE FOREST ZOROARK at all
