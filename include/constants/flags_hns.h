...
#define FLAG_HIDE_ICE_PATH_ALDER                    0x0A3
...
#define FLAG_ITEM_ROUTE39_TM_BUG_BITE               (HNS_ITEM_BALL_START + 187)
...
#define FLAG_GOT_TM_BULLET_SEED                     (HNS_ITEMS_2_START + 0)
...
#define FLAG_ITEM_ROUTE37_TM_HONE_CLAWS             (HNS_ITEMS_2_START + 7)
...
#define FLAG_NEWSINJOH_HOUSE1_ELIZABETH_GAVERIOLU                     (HNS_EXTENDED_CONTENT_START + 31)

#define FLAG_HIDE_NEWSINJOH_HOUSE3_NOBLE_TYPHLOSION                     (HNS_EXTENDED_CONTENT_START + 32)
#define FLAG_DEFEATED_ROUTE39_TAUROS                (HNS_EXTENDED_CONTENT_START + 33)
...
#define FLAG_ITEM_ROUTE30_TM_DRAIN_PUNCH            (HNS_EXTENDED_CONTENT_START + 38)
...
#define FLAG_HIDE_MRPOKEMON_BILL                    (HNS_EXTENDED_CONTENT_START + 111)
#define FLAG_DEFEATED_BILL_SCIENTIST                (HNS_EXTENDED_CONTENT_START + 112)
#define FLAG_HIDE_MIRAGE_ZOROARK                    (HNS_EXTENDED_CONTENT_START + 113)
#define FLAG_BATTLED_MIRAGE_ZOROARK                 (HNS_EXTENDED_CONTENT_START + 114)
#define FLAG_ITEM_MIRAGE_FOREST_NEVER_MELT_ICE      (HNS_EXTENDED_CONTENT_START + 115) // HNS_ITEMS_2 is exactly full (0x268+120 = FLAG_TELEPORTER_UNLOCKED), so MIRAGE FOREST item balls live here
#define FLAG_ITEM_MIRAGE_FOREST_MAX_REVIVE          (HNS_EXTENDED_CONTENT_START + 116)
#define FLAG_HIDE_MIRAGE_HOUSE_GRANDMAS             (HNS_EXTENDED_CONTENT_START + 117)
#define FLAG_HIDE_MIRAGE_POLTEAGEIST                (HNS_EXTENDED_CONTENT_START + 118)
#define FLAG_BATTLED_MIRAGE_POLTEAGEIST             (HNS_EXTENDED_CONTENT_START + 119)
...
#define FLAG_GOT_CAPTAIN_TROPIUS                    (HNS_EXTENDED_CONTENT_START + 319)
#define FLAG_ITEM_ROUTE20_TM_FLAME_CHARGE           (HNS_EXTENDED_CONTENT_START + 320)
#define FLAG_ITEM_ALPH_TM_COSMIC_POWER              (HNS_EXTENDED_CONTENT_START + 321)
