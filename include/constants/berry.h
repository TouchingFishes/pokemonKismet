...
// DaoDao Berry Forest. Due to the nature of BERRY_TREES_COUNT starting from
// this comment, Emerald berries get overwritten.
// Porymap will show each tree's HOENN name!
#define BERRY_TREE_BERRY_FOREST_CHERI    BERRY_TREE_ROUTE_103_CHERI_1
#define BERRY_TREE_BERRY_FOREST_CHESTO   BERRY_TREE_ROUTE_116_CHESTO_1
#define BERRY_TREE_BERRY_FOREST_PECHA    BERRY_TREE_ROUTE_112_PECHA_1
#define BERRY_TREE_BERRY_FOREST_RAWST    BERRY_TREE_ROUTE_112_RAWST_1
#define BERRY_TREE_BERRY_FOREST_ASPEAR   BERRY_TREE_ROUTE_120_ASPEAR_1
#define BERRY_TREE_BERRY_FOREST_PERSIM   BERRY_TREE_ROUTE_114_PERSIM_1
#define BERRY_TREE_BERRY_FOREST_LUM_1    BERRY_TREE_ROUTE_119_LEPPA
#define BERRY_TREE_BERRY_FOREST_LUM_2    BERRY_TREE_ROUTE_111_RAZZ_1
