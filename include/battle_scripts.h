...
extern const u8 BattleScript_DazzlingActivates[];
extern const u8 BattleScript_DazzlingPrevented[];
...
extern const u8 BattleScript_DroppedItemObtained[];
extern const u8 BattleScript_DroppedItemBagFull[];
